...
class ServerBase(object):
        ...
        if acc > self.maxAcc:
            ...
            if(self.save):
                for clientSave in self.clients:
                    best_model_path= "/root/autodl-tmp/fedwl/results/kronoDroid/"+str(self.args.algorithm)+"-models/"+str(global_epoch)
    ...
    def drawFeature(self,bestEpoch):
        ...
        if self.args.algorithm=="FedCPCL":
            name = "FedLFP"
        elif self.args.algorithm == "FedSC":
            name = "FedPSS"
        else:
        ...
        savepath= "/root/autodl-tmp/fedwl/results/kronoDroid/" + name + ".pdf"
