import random
import time
from src.FedRepAPA.client_FedRepAPA import ClientFedRepAPA
from src.server_base import ServerBase
from mem_utils import MemReporter
import torch
import copy
class ServerFedRepAPA(ServerBase):
    def __init__(self, args):
        super().__init__(args)
        self.initialize_clients(ClientFedRepAPA)
    ...
    def dispatch(self, client, aggregated):
        ...
        client.global_model.load_state_dict(aggregated)
