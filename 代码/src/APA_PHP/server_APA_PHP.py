...
from src.APA_PHP.client_APA_PHP import ClientAPA_PHP
from src.server_base import ServerBase


class ServerAPA_PHP(ServerBase):
    def __init__(self, args):
        super().__init__(args)

        self.initialize_clients(ClientAPA_PHP)
    ...
    def dispatch(self, client, aggregated):
        client.previous_model.base.load_state_dict(client.model.base.state_dict())
