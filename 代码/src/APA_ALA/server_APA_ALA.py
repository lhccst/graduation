...
from src.APA_ALA.client_APA_ALA import ClientAPA_ALA
from src.server_base import ServerBase


class ServerAPA_ALA(ServerBase):
    def __init__(self, args):
        super().__init__(args)

        self.initialize_clients(ClientAPA_ALA)
    ...
    def dispatch(self, client, server_aggregated):
        client.server_model = server_aggregated
        client.model.base.load_state_dict(server_aggregated)
