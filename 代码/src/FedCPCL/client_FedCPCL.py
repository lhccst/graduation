...
class ClientFedCPCL(ClientBase):
    ...
    def draw(self,bestEpoch):
        best_model_path = "/root/autodl-tmp/FedPSY226/results/kronoDroid/FedCPCL-models/" + str(bestEpoch)
        ...
        with torch.no_grad():  # 关闭梯度计算，加快推理速度
            ...
            scatter = plt.scatter(features_2d[:, 0], features_2d[:, 1], c=test_labels, cmap='tab10', s=50, alpha=0.7)
